...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [2.0, "reload_revolver", combat+2650, combat+2860, arf_blend_in_8], # Editado
 ],
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [1.5, "new_rifle", 0, 5, blend_in_ready], # Editado
 ],
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.2, "new_rifle", 6, 18, arf_blend_in_1], # Editado
 ],
 ["reload_musket", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [3.0, "new_rifle_reload", 0, 224, arf_blend_in_8],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["equip_bayonet", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [0.3, "ready_musket", 1, 3, arf_blend_in_0], # Editado "equip_musket", 5, 13,
 ],
...
["crouch_unarmed", 0, amf_client_prediction, # Fix by Dunde
 ...
 ["reload_pistol_half", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.2, "reload_pistol_new", 125, 250, arf_blend_in_3], # Editado
 ],
 ...
 ["ready_thrust_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [ready_durn, "thrust_new", 1, 19, blend_in_ready], #Editado "musket_thrust_forward"
 ],
 ["release_thrust_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  [0.9, "thrust_new", 19, 50, blend_in_release], #Editado "musket_thrust_forward"
 ],
 ["release_thrust_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.2, "thrust_new", 50, 54, arf_blend_in_2], #Editado "musket_thrust_forward"
 ],
 ["parried_thrust_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration, "thrust_new", 1, 9, arf_blend_in_2], #Editado "musket_thrust_forward_parry"
 ],
 ["blocked_thrust_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration, "thrust_new", 1, 9, arf_blend_in_2], #Editado "musket_thrust_forward_parry"
 ],
...
#["sitting", 0, amf_client_prediction,
#   [18, "sitting", 0, 198, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
#["sitting_chair", 0, amf_client_prediction,
#   [18, "sit", 0, 4, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
#["dancer_stand", 0, amf_client_prediction,
#   [18, "dancer_stand", 0, 176, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
#["sleeping", 0, amf_client_prediction,
#   [18, "sleeping", 0, 24, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
#["prone",0, amf_client_prediction,
#  [0.7, "prone_test", 1, 2, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
#["stop_musket", acf_enforce_all, amf_priority_die|amf_play,[0,"anim_human",combat+1319,combat+1320,0]], #animation used just to stop "ready" animation when
