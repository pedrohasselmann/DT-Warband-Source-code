...
######################################################
### CHARACTER CREATION SCREEN v1.2 by Mercury 19 #####
######################################################
  ...
  ("mcc_character_creation", 0, 0, [
    (ti_on_presentation_load,
      [
        ...
        (overlay_add_item, "$g_presentation_obj_father", "@a gunslinger"),
        (overlay_add_item, "$g_presentation_obj_father", "@a physician"),
        (overlay_add_item, "$g_presentation_obj_father", "@a bandit"),
        (overlay_add_item, "$g_presentation_obj_father", "@a manni"),
        (overlay_add_item, "$g_presentation_obj_father", "@a hunter"),
        (overlay_add_item, "$g_presentation_obj_father", "@a veteran military man"),
        (overlay_add_item, "$g_presentation_obj_father", "@a travelling merchant"),
        (overlay_add_item, "$g_presentation_obj_father", "@an aristocrat"),
        ...
        (try_begin),
           ...
           (overlay_add_item, "$g_presentation_obj_early", "@a patrician's child"),
        (else_try),
           (overlay_add_item, "$g_presentation_obj_early", "@a street urchin"),
        (try_end),
        (overlay_add_item, "$g_presentation_obj_early", "@a travelling performer"),
        (overlay_add_item, "$g_presentation_obj_early", "@a shop assistant"),
        (overlay_add_item, "$g_presentation_obj_early", "@a wizard's acolyte"),
        (overlay_add_item, "$g_presentation_obj_early", "@a craftsman's student"),
        (try_begin),
           (eq,"$background_type",cb_nomad),
           (overlay_add_item, "$g_presentation_obj_early", "@a manni youngling"),
        (else_try),
           (eq,"$character_gender",tf_male),
           (this_or_next|eq,"$background_type",cb_noble),
           (eq,"$background_type",cb_priest),
           (overlay_add_item, "$g_presentation_obj_early", "@a gunslinger's apprentice"),
        (else_try),
        ...
        (try_begin),
           #(eq,"$character_answer_2",cb2_page),
           (eq,"$character_gender",tf_male),
           (this_or_next|eq,"$background_type",cb_noble),
           (eq,"$background_type",cb_priest),
           (overlay_add_item, "$g_presentation_obj_adult", "@a gunslinger"),
        (else_try),
           (eq,"$character_gender",tf_female),
           (overlay_add_item, "$g_presentation_obj_adult", "@a lady-in-waiting"),
        (else_try),
           (overlay_add_item, "$g_presentation_obj_adult", "@a guard"),          
        (try_end),
		(overlay_add_item, "$g_presentation_obj_adult", "@a wiseman"),
		(overlay_add_item, "$g_presentation_obj_adult", "@a troubadour"),
		(overlay_add_item, "$g_presentation_obj_adult", "@a holy manni"),
		...
		(overlay_add_item, "$g_presentation_obj_adult", "@a crimsom king courtier"),
		(overlay_set_val, "$g_presentation_obj_adult", "$background_answer_3"),
		
		(create_text_overlay, reg1, "@I search the Tower...", tf_center_justify),
        (position_set_x, pos1, 1000),
        (position_set_y, pos1, 1000),
        (overlay_set_size, reg1, pos1),
		(position_set_x, pos1, 150),
		...
		(overlay_add_item, "$g_presentation_obj_reason", "@for power"),
        (overlay_add_item, "$g_presentation_obj_reason", "@because I was forced out of home"),
        (overlay_add_item, "$g_presentation_obj_reason", "@for enlightement"),
        (overlay_add_item, "$g_presentation_obj_reason", "@just wanderlust"),
		...
		## Value
		 ...
		 ### WEAPON PROF - FIREARM ###
		 # Label
		 (create_text_overlay, reg1, "@Firearm"),
         (position_set_x, pos1, 900),
         (position_set_y, pos1, 900),
         (overlay_set_size, reg1, pos1),
         (position_set_x, pos1, 695),
		...
		## Value
		 (create_text_overlay, "$g_presentation_obj_firearm", "str_mcc_zero", tf_center_justify),
         (position_set_x, pos1, 850),
         (position_set_y, pos1, 850),
         (overlay_set_size, "$g_presentation_obj_firearm", pos1),
         (position_set_x, pos1, 805),
         (position_set_y, pos1, 360),
         (overlay_set_position, "$g_presentation_obj_firearm", pos1),				 
