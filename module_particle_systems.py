...
# Editado
 ...
 ("gun_sparks", psf_billboard_3d|psf_randomize_size,  "prt_sparks_mesh_1",
     1, 0.1, 0.0, 0.0, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.7, 0.6), (0.3, 0),          #alpha keys
     (1.0, 1.0), (1, 0),      #red keys
     (0.8, 0.3),(0.1, 0),       #green keys
     (0.0, 0.0), (0.0, 0),      #blue keys
     (0.1, 0.1), (0.1, 0.1,),    #scale keys
     (0.00, 0.00, 0.0),           #emit box size
     (0, 0.2, 0),                 #emit velocity
     5.0,                       #emit dir randomness
    ),

 ("mod_blast", psf_billboard_3d, "prtcl_explosion",
     50, 0.4, 12, -0.2, 2, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 1.5),   (0.5, 25),   #scale keys
 ...
 ("explosion_dirt", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_global_emit_dir, "prtcl_dust_a",#prt_mesh_explosion_mud
     8000, 3,  3, 2, 0, 0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (1, 1), (1, 0),        #alpha keys
     (1, 0.75), (0.5, 0.25),        #red keys
     (1, 0.75), (0.5, 0.25),         #green keys
     (1, 0.75), (0.5, 0.25),         #blue keys
     (3.0, 3.0),   (4.0, 4.0),   #scale keys
     (0, 0, 0),           #emit box size
   ...
   ("explosive_explosion_smoke", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
     300, 10, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
