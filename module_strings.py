...
# Editado -- Meses de acordo com Mid-World festivals
  ("january_reg1_reg2", "Winter {reg1}, {reg2}"),
  ("february_reg1_reg2", "Wide Earth {reg1}, {reg2}"),
  ("march_reg1_reg2", "Sowing {reg1}, {reg2}"),
  ("april_reg1_reg2", "New Earth {reg1}, {reg2}"),
  ("may_reg1_reg2", " Fresh Commala {reg1}, {reg2}"),
  ("june_reg1_reg2", "Mid-Summer {reg1}, {reg2}"),
  ("july_reg1_reg2", "Summer {reg1}, {reg2}"),
  ("august_reg1_reg2", "Full Earth {reg1}, {reg2}"),
  ("september_reg1_reg2", "Reaping {reg1}, {reg2}"),
  ("october_reg1_reg2", "Reaptide {reg1}, {reg2}"),
  ("november_reg1_reg2", "Reap Morn {reg1}, {reg2}"),
  ("december_reg1_reg2", "Year's End {reg1}, {reg2}"),
  ...
  ("s5_is_a_nobleman_of_s6", "{s5} is an aristocrat of {s6}. "), # Editado
...
# Bloco Editado 
  ("fleed_across_desert", "You had been struck by a momentary dizziness, a kind of yawing sensation that made the entire world seem ephemeral, almost a thing that could be looked through. It passed and, like the world upon whose hide he walked, he moved on."),
...
#":skill_ka"
#":skill_magic"	
	("mcc_skl_drawcharge", "Draw and Charge"),
	("mcc_skl_grenadethrow", "Grenade Throw"),
	("mcc_skl_explosives", "Explosives"),
	("mcc_skl_seamanship", "Seamanship"),
	("mcc_skl_magic", "Magic"),
	("mcc_skl_ka", "Ka"),
